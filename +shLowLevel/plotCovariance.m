...
%
%   H = shLowLevel.plotCovariance(M, IDX) shows a P x P covariance (e.g. from
%   shLowLevel.readSINEX with Index=IDX) as an image in shIndex ordering, with
...
assert(isequal(size(M), [idx.P idx.P]), 'shLowLevel:plotCovariance:badSize', ...
