...
%
%   H = shLowLevel.taylorDiagram(REFSTD, STDS, CORRS) draws the standard
...
%   .corr fields of shLowLevel.spatialStats, or temporal statistics from
...
if numel(stds) ~= numel(corrs)
    error('shLowLevel:taylorDiagram:sizeMismatch', ...
