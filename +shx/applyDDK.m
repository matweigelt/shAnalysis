...
%
%   [CF, SF] = shx.applyDDK(C, S, W) applies the filter container from
%   shx.readDDK: within each (order m, cs) block, the degree vector
...
%     W     struct           from shx.readDDK (nmax, blocks(m,cs,n,M))
%   Outputs
