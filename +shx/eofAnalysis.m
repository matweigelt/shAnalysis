...
%
%   [MODES, PCS, VAREXPLAINED, INFO] = shx.eofAnalysis(TS) decomposes
...
%       [modes, pcs, ve] = shx.eofAnalysis(resid);
%
%   Inputs
...
assert(T >= 3, 'shx:eofAnalysis:tooFewEpochs', ...
