...
%
%   [SIG, LAT, LON] = shx.errorMap(M, IDX, LAT, LON, quantity="ewh",
%       kn=kn) computes the pointwise 1-sigma of a synthesized field
%   from a full P x P covariance (e.g. shx.readSINEX(...,
...
P = idx.P;
assert(isequal(size(M), [P P]), 'shx:errorMap:badSize', ...
...
Pleg = shx.legendreALF(nmax, latRad);
m = (0:nmax)';
