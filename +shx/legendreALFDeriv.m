...
%
%   [P, D] = shx.legendreALFDeriv(NMAX, LATRAD) returns the 4pi-fully-
%   normalized associated Legendre functions P (via shx.legendreALF,
...
%   deformation (shx.shSynthesisDeformation) and any future gradient/
%   vector synthesis.
%
%   Inputs
