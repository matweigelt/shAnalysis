...
%
%   TN = shx.readTN14(FILENAME) reads the CSR/GFZ "TN-14" technical-note
...
assert(fid > 0, 'shx:readTN14:fileNotFound', 'Cannot open %s.', char(filename));
...
assert(~isempty(rows), 'shx:readTN14:noData', ...
