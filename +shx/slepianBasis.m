...
%
%   [G, LAM, INFO] = shx.slepianBasis(IDX, REGION) solves the spherical
...
%
%   Inputs
%     idx     struct  shx.shIndex (P x P eig: fine to Lmax ~ 60-96)
%     region  handle | polygon | mask   (see shx.evalMask)
%   Options
%     NKeep (round(Shannon))  columns of G to return; [] = all P
%     BufferKm (0), R (6378136.3)  passed to shx.evalMask
%   Outputs
