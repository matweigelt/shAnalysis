...
methods
    ...
    function out = removeAlias(obj, opts)
        ...
        if rank(A) < size(A, 2)
            error('shSeries:removeAlias:rankDeficient', ...
                ['The %d epochs cannot support the 8-term fit (bias, ' ...
                 'trend, annual, semi-annual, alias). A series shorter ' ...
                 'than about two years cannot separate a 161-day ' ...
                 'harmonic from the annual cycle.'], numel(t));
        end
        n1 = obj.nmax + 1;
